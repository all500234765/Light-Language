...
if (argument_count > 1) {
  ...
  if (is_real(_id) || is_int32(_id) || is_int64(_id))
    sr_buffer_write_val(in, _id, ERousrData.Uint32);
  else 
    sr_buffer_write_val(in, string(_id));
}
_extImguiGML_get_id();
...
///@function imguigml_sprite(_sprite_index, _sub_img, [_width=undefined], [_height=undefiend], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0], [_border_r=0.0], [_border_g=0.0], [_border_b=0.0], [_border_a=0.0], [u1=undefined], [v1=undefined], [u2=undefined], [v2=undefined])
///@desc ImGui::Image()
...
///@param {Real} [_border_b=0.0]       border color b
///@param {Real} [_border_a=0.0]       border color a
///@param {Real} [_u1=undefined]       uses sprite u1 if undefined
///@param {Real} [_v1=undefined]       uses sprite v1 if undefined
///@param {Real} [_u2=undefined]       uses sprite texture width if undefined
///@param {Real} [_v2=undefined]       uses sprite texture height if undefined
var argi = 0,
	...
	u1 = (argument_count > 12) ? argument[argi++] : undefined,
	v1 = (argument_count > 13) ? argument[argi++] : undefined,
	u2 = (argument_count > 14) ? argument[argi++] : undefined,
	v2 = (argument_count > 15) ? argument[argi++] : undefined,
	uvs = sprite_get_uvs(sprite, sub_img),
	texture_id_gml = sprite_get_texture(sprite, sub_img),
	texture_id = __imguigml_texture_id(sprite, sub_img, EImGuiGML_TextureType.Sprite);


if is_undefined(u1) u1 = uvs[0];
if is_undefined(v1) v1 = uvs[1];
if is_undefined(u2) u2 = uvs[2] * (texture_get_width(texture_id_gml) / uvs[6]);
if is_undefined(v2) v2 = uvs[3] * (texture_get_height(texture_id_gml) / uvs[7]);
...
///@function imguigml_sprite_button(_sprite_index, _sub_img, [_width=undefined], [_height=undefiend], [_bg_r=0.0], [_bg_g=0.0], [_bg_b=0.0], [_bg_a=0.0], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0], [u1=undefined], [v1=undefined], [u2=undefined], [v2=undefined])
///@desc ImGui::ImageButton()
///@param {Real} _sprite_index         sprite
...
var argi = 0,
	...
	u1 = (argument_count > 13) ? argument[argi++] : undefined,
	v1 = (argument_count > 14) ? argument[argi++] : undefined,
	u2 = (argument_count > 15) ? argument[argi++] : undefined,
	v2 = (argument_count > 16) ? argument[argi++] : undefined,
	uvs = sprite_get_uvs(sprite, sub_img),
	texture_id_gml = sprite_get_texture(sprite, sub_img),
	texture_id = __imguigml_texture_id(sprite, sub_img, EImGuiGML_TextureType.Sprite);
...
return __imguigml_image_button(texture_id, width, height, u1, v1, u2, v2, frame_padding, bgr, bgg, bgb, bga, tintr, tintg, tintb, tinta);
...
if (argument_count > 0) {
  var in = __Imgui_in;
  sr_buffer_write_val(in, argument0, ERousrData.String);
...
_extImguiGML_drawlist_add_line(); 
...
///@param {Real} [_rounding_corner_flags=-1]
///@param {Real} [_thickness=1.0]
...
_extImguiGML_drawlist_add_rect();
...
sr_buffer_write_val(_in, argument_count > 5 ? argument[argi++] : 0,   ERousrData.Float);
sr_buffer_write_val(_in, argument_count > 6 ? argument[argi++] : -1,  ERousrData.Int32);
_extImguiGML_drawlist_add_rect_filled();
...
sr_buffer_write_val(_in, argument[argi++], ERousrData.Uint32);
sr_buffer_write_val(_in, argument[argi++], ERousrData.Uint32);
_extImguiGML_drawlist_add_rect_filled_multicolor();  
...
_extImguiGML_drawlist_add_quad();
...
sr_buffer_write_val(_in, argument[8], ERousrData.Uint32);
sr_buffer_write_val(_in, argument_count > 9 ? argument[9] : 1.0, ERousrData.Float);
_extImguiGML_drawlist_add_quad_filled();
...
sr_buffer_write_val(in, argument_count > 7 ? argument[7] : 1.0, ERousrData.Float);
_extImguiGML_drawlist_add_triangle();
...
sr_buffer_write_val(in, argument[5], ERousrData.Float);
sr_buffer_write_val(in, argument[6], ERousrData.Uint32);
_extImguiGML_drawlist_add_triangle_filled();
...
sr_buffer_write_val(in, argument_count > 5 ? argument[5] : 1.0, ERousrData.Float);
_extImguiGML_drawlist_add_circle();
...
sr_buffer_write_val(in, argument[3], ERousrData.Uint32);
sr_buffer_write_val(in, argument_count > 4 ? argument[4] : 12, ERousrData.Int32);
_extImguiGML_drawlist_add_circle_filled();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.String);
sr_buffer_write_val(in, argument[argi++], ERousrData.Float);
_extImguiGML_drawlist_add_text();
...
_extImguiGML_drawlist_add_image();
...
///@function imguigml_drawlist_add_sprite(_sprite_index, _sub_img, _x, _y, [_width=undefined], [_height=undefined], [_col=c_white], [_u1=undefined], [_v1=undefined], [_u2=undefined], [_v2=undefined])
///@desc Adds an image to the draw list 
...
///@param {Real} [_col=c_white]
///@param {Real} [_u1=undefined] 
///@param {Real} [_v1=undefined] 
///@param {Real} [_u2=undefined] 
///@param {Real} [_v2=undefined] 
...
var in = __Imgui_in, argi = 0,
	...
	u1 = (argument_count > 7)  ? argument[argi++] : undefined,
	v1 = (argument_count > 8)  ? argument[argi++] : undefined,
	u2 = (argument_count > 9)  ? argument[argi++] : undefined,
	v2 = (argument_count > 10) ? argument[argi++] : undefined,
	uvs = sprite_get_uvs(sprite, sub_img),
	texture_id_gml = sprite_get_texture(sprite, sub_img),
	texture_id = __imguigml_texture_id(sprite, sub_img, EImGuiGML_TextureType.Sprite);
...
_extImguiGML_drawlist_add_image_quad();

#define imguigml_drawlist_add_sprite_quad
///@function imguigml_drawlist_add_sprite_quad(_sprite_index, _sub_img, _x1, _y1, _x2, _y2, x3, _y3, _x4, _y4, [_u1=undefined], [_v1=undefined], [_u2=undefined], [_v2=undefined], [_u3=undefined], [_v3=undefined], [_u4=undefined], [_v4=undefined], [_col=c_white])
///@desc Adds an image quad to the draw list 
///@param {Real} _sprite_index
///@param {Real} _sub_img
///@param {Real} _x1 
...
///@param {Real} [_u2=undefined] 
///@param {Real} [_v2=undefined]
///@param {Real} [_u3=undefined]
///@param {Real} [_v3=undefined]
///@param {Real} [_u4=undefined]
///@param {Real} [_v4=undefined]
...
var in = __Imgui_in, argi = 0,
	...
	x4 = argument[argi++],
	y4 = argument[argi++],
	col = (argument_count > 10) ? argument[argi++] : 0xFFFFFFFF,
	u1 = (argument_count > 11) ? argument[argi++] : undefined,
	v1 = (argument_count > 12) ? argument[argi++] : undefined,
	u2 = (argument_count > 13) ? argument[argi++] : undefined,
	v2 = (argument_count > 14) ? argument[argi++] : undefined,
	u3 = (argument_count > 15) ? argument[argi++] : undefined,
	v3 = (argument_count > 16) ? argument[argi++] : undefined,
	u4 = (argument_count > 17) ? argument[argi++] : undefined,
	v4 = (argument_count > 18) ? argument[argi++] : undefined,
	texture_id = __imguigml_texture_id(sprite, sub_img, EImGuiGML_TextureType.Sprite),
	texture_id_gml = sprite_get_texture(sprite, sub_img),
	uvs = sprite_get_uvs(sprite, sub_img),
	//Top left
	...
	cv1 = uvs[1],
	//Bottom Right
	cu2 = uvs[2] * (texture_get_width(texture_id_gml) / uvs[6]),
	cv2 = uvs[3] * (texture_get_height(texture_id_gml) / uvs[7]);
	
//Top left
if is_undefined(u1) u1 = cu1;
if is_undefined(v1) v1 = cv1;
//Top Right
if is_undefined(u2) u2 = cu2;
if is_undefined(v2) v2 = cv1;
//Bottom Right
if is_undefined(u3) u3 = cu2;
if is_undefined(v3) v3 = cv2;
//Bottom Left 
if is_undefined(u4) u4 = cu1;
if is_undefined(v4) v4 = cv2;
...
sr_buffer_write_val(in, argument_count > 4 ? argument[argi++] : true, ERousrData.Bool);
_extImguiGML_drawlist_add_polyline();
...
_extImguiGML_drawlist_add_convex_poly_filled();
...
sr_buffer_write_val(in, argument[0], ERousrData.Float);
sr_buffer_write_val(in, argument[1], ERousrData.Float);
_extImguiGML_drawlist_path_line_to();
...
sr_buffer_write_val(in, argument[0], ERousrData.Float);
sr_buffer_write_val(in, argument[1], ERousrData.Float);
_extImguiGML_drawlist_path_line_to_merge_duplicate();
...
var in = __Imgui_in;
sr_buffer_write_val(in, argument[0], ERousrData.Uint32);
_extImguiGML_drawlist_path_fill_convex();
...
_extImguiGML_drawlist_path_stroke();
...
_extImguiGML_drawlist_path_arc_to();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Float);
sr_buffer_write_val(in, argument[argi++], ERousrData.Float);
_extImguiGML_drawlist_path_arc_to_fast();
...
_extImguiGML_drawlist_path_bezier_curve_to();
...
///@param {Real} [_round_corner_flags=-1
var in = __Imgui_in, argi = 0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Float);
sr_buffer_write_val(in, argument[argi++], ERousrData.Float);
sr_buffer_write_val(in, argument[argi++], ERousrData.Float);
...
sr_buffer_write_val(in, argument_count > argi ? argument[argi] : 0.0, ERousrData.Float); argi++;
sr_buffer_write_val(in, argument_count > argi ? argument[argi] : 0, ERousrData.Int32); argi++;
_extImguiGML_drawlist_path_rect();
...
sr_buffer_write_val(__Imgui_in, argument[0], ERousrData.Int32);
_extImguiGML_drawlist_channels_split();
...
///      - Use to simulate layers. By switching channels to can render out-of-order (e.g. submit foreground primitives before background primitives)
///      - Use to minimize draw calls (e.g. if going back-and-forth between multiple non-overlapping clipping rectangles, prefer to append into separate channels then merge at the end)
_extImguiGML_drawlist_channels_merge();
...
var in = __Imgui_in;
sr_buffer_write_val(in, argument[0], ERousrData.Int32);
_extImguiGML_drawlist_channels_set_current();
...
_extImguiGML_drawlist_push_clip_rect_fullscreen();
...
_extImguiGML_drawlist_get_clip_rect_min();
...
_extImguiGML_drawlist_get_clip_rect_max();
var out = __Imgui_out, ret = array_create(2);
ret[@ 0] = buffer_read(out, buffer_f32);
ret[@ 1] = buffer_read(out, buffer_f32);
return ret;
...
_extImguiGML_set_display_size(window_get_width(), window_get_height());
...
_extImguiGML_create_font_texture(Next_texture_id, buffer_get_address(arg_buffer));
...
var in = __Imgui_in;
sr_buffer_write_val(in, argument[0]);
_extImguiGML_extra_set_tab_item_closed();
...
var in = __Imgui_in;
sr_buffer_write_val(in, argument[0]);
_extImguiGML_extra_set_tab_item_selected();
...
_extImguiGML_extra_show_tabs_demo();
if (_open != undefined)
  return buffer_read(__Imgui_out, buffer_s8) != 0;
...
_extImguiGML_texteditor_destroy();
return undefined;
...
var in = __Imgui_in;
sr_buffer_write_val(in, argument[0], ERousrData.Int32);
_extImguiGML_texteditor_get_language_definition();
...
var in = __Imgui_in;
sr_buffer_write_val(in, argument[0], ERousrData.Uint32);
_extImguiGML_texteditor_get_palette();
var out = __Imgui_out;
...
_extImguiGML_texteditor_set_palette();
...
_extImguiGML_texteditor_render();
...
///@param {Real} _editor_index 
///@param {String} _text
_extImguiGML_texteditor_set_text(argument0, argument1); // special case, we just use the DLL API since buffers can be HUGE!
...
var in = __Imgui_in, argi=0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_get_selected_text();
var out = __Imgui_out;
return buffer_read(out, buffer_string);
...
var in = __Imgui_in, argi=0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_get_total_lines();
var out = __Imgui_out;
...
var in = __Imgui_in, argi=0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_is_overwrite();
var out = __Imgui_out;
return buffer_read(out, buffer_s8) != 0;
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument[argi++], ERousrData.Bool);
_extImguiGML_texteditor_set_read_only();
...
var in = __Imgui_in, argi=0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_is_read_only();
var out = __Imgui_out;
return buffer_read(out, buffer_s8) != 0;
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_set_cursor_position();
...
var in = __Imgui_in, argi=0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_get_cursor_position();
var out = __Imgui_out;
var ret = array_create(2);
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument[argi++], ERousrData.String);
_extImguiGML_texteditor_insert_text();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument_count > argi ? argument[argi] : false, ERousrData.Bool); argi++;
_extImguiGML_texteditor_move_up();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument_count > argi ? argument[argi] : false, ERousrData.Bool); argi++;
_extImguiGML_texteditor_move_down();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument_count > argi ? argument[argi] : false, ERousrData.Bool); argi++;
_extImguiGML_texteditor_move_left();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument_count > argi ? argument[argi] : false, ERousrData.Bool); argi++;
_extImguiGML_texteditor_move_right();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument_count > argi ? argument[argi] : false, ERousrData.Bool); argi++;
_extImguiGML_texteditor_move_top();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument_count > argi ? argument[argi] : false, ERousrData.Bool); argi++;
_extImguiGML_texteditor_move_bottom();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument_count > argi ? argument[argi] : false, ERousrData.Bool); argi++;
_extImguiGML_texteditor_move_home();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument_count > argi ? argument[argi] : false, ERousrData.Bool); argi++;
_extImguiGML_texteditor_move_end();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_set_selection_start();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_set_selection_end();
...
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
sr_buffer_write_val(in, argument_count > argi ? argument[argi] : false, ERousrData.Bool); argi++;
_extImguiGML_texteditor_set_selection();
...
var in = __Imgui_in, argi=0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_select_word_under_cursor();
...
var in = __Imgui_in, argi=0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_has_selection();
var out = __Imgui_out;
return buffer_read(out, buffer_s8) != 0;
...
var in = __Imgui_in, argi=0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_delete();
...
var in = __Imgui_in, argi=0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_can_undo();
var out = __Imgui_out;
return buffer_read(out, buffer_s8) != 0;
...
var in = __Imgui_in, argi=0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_can_redo();
var out = __Imgui_out;
return buffer_read(out, buffer_s8) != 0;
...
var in = __Imgui_in, argi=0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_get_dark_palette();
var out = __Imgui_out;
var palette = array_create(EImGuiText_Palette.Num, 0);
var i = 0; repeat(EImGuiText_Palette.Num)
  palette[@i++] = buffer_read(out, buffer_u8);
...
var in = __Imgui_in, argi=0;
sr_buffer_write_val(in, argument[argi++], ERousrData.Int32);
_extImguiGML_texteditor_get_light_palette();
var out = __Imgui_out;
var palette = array_create(EImGuiText_Palette.Num, 0);
var i = 0; repeat(EImGuiText_Palette.Num)
  palette[@i++] = buffer_read(out, buffer_u8);
