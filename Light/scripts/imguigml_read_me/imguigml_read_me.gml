...
**[_border_b=0.0]**     | {Real} border color b   
**[_border_a=0.0]**     | {Real} border color a   
**[_u1=undefined]**     | {Real} uses sprite u1 if undefined   
**[_v1=undefined]**     | {Real} uses sprite v1 if undefined   
**[_u2=undefined]**     | {Real} uses sprite texture width if undefined   
**[_v2=undefined]**     | {Real} uses sprite texture height if undefined   
**returns**:           | None   
```
imguigml_sprite(_sprite_index, _sub_img, [_width=undefined], [_height=undefined], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0], [_border_r=0.0], [_border_g=0.0], [_border_b=0.0], [_border_a=0.0], [_u1=undefined], [_v1=undefined], [_u2=undefined], [_v2=undefined])
```   
ImGui::Image()
...
**returns**:           | {Boolean} _pressed   
```
imguigml_sprite_button(_sprite_index, _sub_img, [_width=undefined], [_height=undefined], [_frame_padding=-1], [_bg_r=0.0], [_bg_g=0.0], [_bg_b=0.0], [_bg_a=0.0], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0], [_u1=undefined], [_v1=undefined], [_u2=undefined], [_v2=undefined])
```   
ImGui::ImageButton()
...
| | | 
| ----------------- | -------------------------------------------------------------- |   
**_texture_id**     | {Real} texture id is a generated id from __imguigml_texture_id   
**_size_x**         | {Real} width   
**_size_y**         | {Real} height   
**[_u0=0.0]**       | {Real} texture u0   
**[_v0=0.0]**       | {Real} texture v0   
...
**returns**:       | None   
```
__imguigml_image(_texture_id, _size_x, _size_y, [_u0=0.0], [_v0=0.0], [_u1=1.0], [_v1=1.0], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0], [_border_r=0.0], [_border_g=0.0], [_border_b=0.0], [_border_a=0.0])
```   
internal imguigml  call to draw an image using the `_texture_id` texture

---

#### `__imguigml_image_button`   
| | | 
| --------------------- | ----------------------------------------------------------------------------- |   
**_texture_id**         | {Real} texture id   
**_size_x**             | {Real} width   
...
**[_v1=1.0]**           | {Real} texture v1   
**[_frame_padding=-1]** | {Real} <0 frame_padding uses default frame padding settings. 0 for no padding   
**[_bg_r=0.0]**         | {Real} backgruond color r   
**[_bg_g=0.0]**         | {Real} backgruond color g   
**[_bg_b=0.0]**         | {Real} backgruond color b   
**[_bg_a=0.0]**         | {Real} backgruond color a   
**[_tint_r=1.0]**       | {Real} tint color r   
**[_tint_g=1.0]**       | {Real} tint color g   
**[_tint_b=1.0]**       | {Real} tint color b   
**[_tint_a=1.0]**       | {Real} tint color a   
**returns**:           | {Boolean} _pressed   
```
__imguigml_image_button(_texture_id, _size_x, _size_y, [_u0=0.0], [_v0=0.0], [_u1=1.0], [_v1=1.0], [_frame_padding=-1], [_bg_r=0.0], [_bg_g=0.0], [_bg_b=0.0], [_bg_a=0.0], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0])
```   
Add a button using the texture stored at `_texture_id` for the appearance
...
**returns**:   | None   
```
imguigml_drawlist_add_line(_x1, _y1, _x2, _y2, _color, [_thickness)
```   
...
**returns**:      | None   
```
__imguigml_drawlist_add_image(_texture_id, _x1, _y1, _x2, _y2, [_u1=0], [_v1=0], [_u2=1], [_v2=1], [_col=c_white])
```   
...
**returns**:           | None   
```
imguigml_drawlist_add_sprite(_sprite_index, _image_index, _x, _y, [_width=undefined], [_height=undefined], [_col=c_white], [_u1=undefined], [_v1=undefined], [_u2=undefined], [_v2=undefined])
```   
Adds an image to the draw list

---

#### `__imguigml_drawlist_add_image_quad`   
| | | 
| ---------------- | ---------------------------------------- |   
**_texture_id**    | {Real} created from _imguigml_texture_id   
**_x1**            | {Real}    
**_y1**            | {Real}    
**_x2**            | {Real}    
**_y2**            | {Real}    
...
**returns**:      | None   
```
__imguigml_drawlist_add_image_quad(_texture_id, _x1, _y1, _x2, _y2, _x3, _y3, _x4, _y4, [_u1=0], [_v1=0], [_u2=1], [_v2=1], [_u3=1], [_v3=1], [_u4=0], [_v4=1], [_col=c_white])
```   
Adds an image quad to the draw list

---

#### `imguigml_drawlist_add_sprite_quad`   
| | | 
| ----------------- | ------- |   
**_sprite_index**   | {Real}    
**_sub_img**        | {Real}    
...
**returns**:       | None   
```
imguigml_drawlist_add_sprite_quad(_sprite_index, _sub_img, _x1, _y1, _x2, _y2, _x3, _y3, _x4, _y4, [_col=c_white], [_u1=undefined], [_v1=undefined], [_u2=undefined], [_v2=undefined], [_u3=undefined], [_v3=undefined], [_u4=undefined], [_v4=undefined])
```   
Adds an image quad to the draw list
...
**[_thickness=1.0]**     | {Real}    
**[_anti_aliased=true]** | {Real}    
**returns**:            | None   
```
imguigml_drawlist_add_polyline(_y]}, _col, [_closed=true], [_thickness=1.0], [_anti_aliased=true])
```   
...
**returns**:            | None   
```
imguigml_drawlist_add_convex_poly_filled(_points, _col, [_anti_aliased=true])
```   
...
#### `__imguigml_texture_id`   
| | | 
| -------------------------- | ---------------------------------------------------------------------------------------------------------------- |   
**_id**                      | {Real} sprite index, surface id, or texture ptr   
**_texture_type_or_sub_img** | {Real|Real:EImGuiGML_TextureType} what type `_id` should be treated as, or a sub image if we're the sprite type.   
**[_texture_type]**          | {Real:EImGuiGML_TextureType} what type `_id` should be treated as (or a sprite, really, if 3 passed)   
**returns**:                | {Real} _id for texture   
```
__imguigml_texture_id(_id, _texture_type_or_sub_img, [_texture_type])
```   
...
#### `__imguigml_handle_text_callback`   
| | | 
| ----------- | ------------------------------------------------------ |   
...
| ----------------- | -------------- |   
**key**             | {String}    
**[default_value]** | {Real|String}    
**returns**:       | {Real|String|undefined}   
```
imguigml_mem(key, [default_value])
```   
Get a value from the memory map
...
**returns**: | {Real|String|undefined}   
```
imguigml_memset(key, value)
```   
Sets a value in the memory map
...
| | | 
| ---------- | ------------------------ |   
**{String}** | filename the path to use   
**returns**: | None   
```
imguigml_secure_save_mem({String})
```   
saves imguigml memory onto the filesystem
...
**returns**: | None   
```
imguigml_secure_load_mem({String})
```   
loads imguigml memory from the filesystem
...
**returns**:      | {Real} buffer_id seek'd to start - this is a sr_buffer and can be used to read parameters in the order expected from the DLL   
```
...
**returns**:          | {Real} sr_buffer (at start) and should be written to using `sr_buffer_write_val`   
```
